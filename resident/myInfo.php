  ...
  <div class="content-wrapper"  style="background-color: transparent">
    ...
    <div class="container-fluid pt-5">
        <form id="editResidenceForm" method="post" enctype="multipart/form-data">
          ...
          <div class="card card-widget widget-user" style="border: 10px solid rgba(0, 0, 0, 0.75); border-radius: 0;">
    ...
    <td>
      ...
      <td>
       PROVINCE
        <br>
       <input type="text" class="editInfo  form-control form-control-sm" value="<?= $row_resident['province'] ?>" name="edit_province" id="edit_province">
    ...
    <td>
        CITY
        <br>
        <input type="text" class="editInfo  form-control form-control-sm" value="<?= $row_resident['city'] ?>" name="edit_city" id="edit_city">
