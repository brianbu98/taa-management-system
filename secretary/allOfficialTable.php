...
try{
  ...
  $sql = "SELECT  official_status.position, official_status.status, official_information.official_id, official_information.first_name, official_information.middle_name, official_information.last_name,
