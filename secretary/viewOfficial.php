  ...
  <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
            <a href="#" class="btn bg-black float-lg-right elevation-5 px-3 btn-flat" onclick="history.go(-1)"><i class="fas fa-backward"></i></a>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
                  ...
                  <div class="tab-pane fade" id="other-info" role="tabpanel" aria-labelledby="other-info-tab">
                        ...
                        <label for="edit_province">Province</label>
                            <input type="text" class="form-control" id="edit_province" name="edit_province" 
                                   value="<?= htmlspecialchars($row_official['province'], ENT_QUOTES, 'UTF-8') ?>">
                            <input type="hidden" id="edit_province_check" name="edit_province_check" value="false">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label>City</label>
                              <input type="text" class="form-control" id="edit_city" name="edit_city" value="<?= $row_official['city'] ?>">
