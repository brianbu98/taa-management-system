...
<div class="modal" id="viewResidenceModal"  role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="modelTitleId" aria-hidden="true">
          ...
          <tbody>
            ...
            <td class="text-center">
              <div style="font-size:10pt;">
                Application for Authority proof that you are a resident of this Teremil<br>
  ...
  <table  style="font-size:11pt;" class="table table-bordered">
    ...
    <td>
      ...
      <td>
       PROVINCE
        <br>
       <input type="text" class="editInfo  form-control form-control-sm" value="<?= $row_view_residence['province'] ?>" name="edit_province" id="edit_province">
    ...
    <td>
        CITY
        <br>
        <input type="text" class="editInfo  form-control form-control-sm" value="<?= $row_view_residence['city'] ?>" name="edit_city" id="edit_city">
        <input type="hidden" id="edit_city_check" value="false">
      </td>
      <td>
        HOUSE NUMBER
        <br>
  ...
  <fieldset>
          ...
          <div class="table-responsive" >
            <table class="table table-sm" id="incidentPersonTable" style="font-size: 13px; font-weight: 200px;">
              <thead>
                <tr>
  ...
  $(document).ready(function(){
    ...
    function viewResidentRecord(){
      ...
      $(document).on('click','.viewRecord',function(){
        ...
        $.ajax({
        url: 'viewRecordIncidentResident.php',
        type: 'POST',
        data:{
          id:id,
    ...
    function deleteResidenceRecord(){
     ...
     var incidentlog_id =   $(this).attr('id');
        ...
        Swal.fire({
            ...
            if (result.value) {
              $.ajax({
                url: 'deleteComplainantIncidentRecord.php',
                type: 'POST',
                data:{
                ...
                success:function(data){
                    Swal.fire({
                      ...
                      $("#incidentPersonTable").DataTable().ajax.reload();
                    })
                }
              }).fail(function(){
                    Swal.fire({
    ...
    function deleteResidenceRecordPerson(){
     ...
     var incidentlog_id =   $(this).attr('id');
        ...
        Swal.fire({
            ...
            if (result.value) {
              $.ajax({
                url: 'deletePersonIncidentRecord.php',
                type: 'POST',
                data:{
                  person_id:person_id,
                  incidentlog_id:incidentlog_id
           ...
           var edit_first_name = $("#edit_first_name").val();
            ...
            $("#edit_first_name").change(function(){
              ...
              $("#edit_last_name").change(function(){
                ...
                if(!(newProvince == edit_province )){

                $("#edit_province_check").val('true');

                }else{

                $("#edit_province_check").val('false');
                }
                ...
                if(!(newCity == edit_city )){

                $("#edit_city_check").val('true');

                }else{

                $("#edit_city_check").val('false');
                }
            ...
            Swal.fire({
              ...
              if (result.value) {
                ...
                var formData = new FormData(form)
                  ...
                  formData.append("edit_province_check",$("#edit_province_check").val())
                  formData.append("edit_zip_check",$("#edit_zip_check").val())
                  formData.append("edit_city_check",$("#edit_city_check").val())
...
(function($) {
  ...
  $("#edit_first_name, #edit_middle_name, #edit_last_name, #edit_suffix, #edit_religion, #edit_nationality, #edit_province, #edit_fathers_name, #edit_mothers_name, #edit_guardian").inputFilter(function(value) {
