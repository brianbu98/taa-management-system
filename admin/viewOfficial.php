                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="edit_province" name="edit_province" value="<?= htmlspecialchars($row_official['province'], ENT_QUOTES, 'UTF-8') ?>">
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                <label>Zip</label>
                                <input type="text" class="form-control" id="edit_zip" name="edit_zip" value="<?= htmlspecialchars($row_official['zip'], ENT_QUOTES, 'UTF-8') ?>">
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                <label>City</label>
                                <input type="text" class="form-control" id="edit_city" name="edit_city" value="<?= htmlspecialchars($row_official['city'], ENT_QUOTES, 'UTF-8') ?>">
