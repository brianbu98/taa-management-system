            ...
            <tr>
              <td class="text-center">
                ...
                if($row_taa_information['image_path'] != '' || $row_taa_information['image_path'] != null || !empty($row_taa_information['image_path'])){
                    echo '<img alt="city_logo" src="'.$row_taa_information['image_path'].'" class="img-circle"  id="city_logo">';
                }else{
                  echo '<img alt="city_logo" src="../assets/logo/blank.png" class="img-circle"  id="city_logo">';
                }
              ...
              <td class="text-center">
                <div style="font-size:10pt;">
                  Application for Authority proof that you are a resident of this city<br>
  ...
  <table  style="font-size:11pt;" class="table table-bordered">
    ...
    <tr>
      <td>
       PROVINCE
        <br>
       <input type="text" disabled class="editInfo  form-control form-control-sm" value="<?= $row_view_residence['province'] ?>" name="edit_province" id="edit_province">
      </td>
      <td>
        ZIP
        <br>
      ...
      <td colspan="2">
        CITY
        <br>
        <input type="text" disabled class="editInfo  form-control form-control-sm" value="<?= $row_view_residence['city'] ?>" name="edit_city" id="edit_city">
      </td>
    </tr>
