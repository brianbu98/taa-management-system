                ...
                <?php 
                    ...
                    <td class="text-center">
                      <div style="font-size:10pt;">
                        Application for Authority proof that you are a resident of this TAA<br>
                        <?= $row_taa_information['taa'] ?><br>
...
<br>
  ...
  <fieldset>
          ...
          <div class="table-responsive" >
            <table class="table table-sm" id="inidentPersonTable" style="font-size: 13px; font-weight: 200px;">
              <thead>
                <tr>
           ...
           var edit_first_name = $("#edit_first_name").val();
            ...
            $("#edit_first_name").change(function(){
              ...
              $("#edit_last_name").change(function(){
                ...
                $("#edit_province _check").val('false');
                }
