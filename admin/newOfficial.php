...
(function($) {
  ...
  $("#add_first_name, #add_middle_name, #add_last_name, #add_suffix, #add_religion, #add_nationality, #add_province, #add_city, #add_fathers_name, #add_mothers_name, #add_guardian").inputFilter(function(value) {
